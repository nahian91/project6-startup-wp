                    ...
                    <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                        <div class="team-item bg-light rounded overflow-hidden">
                            <div class="team-img position-relative overflow-hidden">
                                ...
                                ?>
                                    <a class="btn btn-lg btn-primary btn-lg-square rounded" href="<?php echo $team_social['team_social_link'];?>"><i class="<?php echo $team_social['team_social_icon'];?> fw-normal"></i></a>
                                <?php
                                    }
                                ?>
                                </div>
